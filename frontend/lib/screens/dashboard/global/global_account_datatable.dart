  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final accountLabelWidth = 220.0;
        final remainingWidth = availableWidth - accountCodeWidth - accountLabelWidth;
        final yearColumnWidth = annees.isNotEmpty 
            ? (remainingWidth / annees.length).clamp(100.0, 150.0)
            : 100.0;
                      ...
                      columns: [
                        ...
                        ...annees.map((an) => DataColumn(
                              label: Container(
                                ...
                                child: Text(an, style: TextStyle(fontSize: 13), textAlign: TextAlign.center),
                              ),
                            )),
                      ],
                      rows: hasComptes
